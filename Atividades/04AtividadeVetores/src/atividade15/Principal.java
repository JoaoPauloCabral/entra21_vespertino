...
public class Principal {
	...
	public static void main(String[] args) {
		...
		if((agua == 0) && (bomba == 0)) {
			JOptionPane.showMessageDialog(null, "Nenhum erro: Nossa!!! Acertou na mosca");
		
		}else if((agua >= 5) && (bomba > 3)) {
			JOptionPane.showMessageDialog(null, "Parabens! Você é bom nesse jogo");
		}else if((agua >= 10) && (bomba > 3)) {
			JOptionPane.showMessageDialog(null, "Otimo, voce foi muito bem");
		}else if((agua >= 20) && (bomba > 3)) {
			JOptionPane.showMessageDialog(null, "Poderia ser melhor, tente novamente");
		}else if((agua >= 20) && (bomba > 3)) {
			JOptionPane.showMessageDialog(null, "Voçê é muito ruim nesse jogo");
		}	

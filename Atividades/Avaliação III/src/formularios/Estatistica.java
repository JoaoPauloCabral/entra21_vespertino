...
public class Estatistica extends JFrame {
	...
	public Estatistica() {
		...
		btnSair.setBounds(227, 648, 89, 23);
		...
		lblNenhumaFalta.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		lblAtTrsFaltas.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		lblAtCincoFaltas.setFont(new Font("Tahoma", Font.PLAIN, 10));
		...
		lblAcimaDeCinco.setFont(new Font("Tahoma", Font.PLAIN, 10));

...
public class FPrincipal extends JFrame {
	...
	public FPrincipal() {
		...
		JButton btnFeijão1 = new JButton("+");
		
		btnFeijão1.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnFeijão1.setBounds(152, 52, 43, 40);
		contentPane.add(btnFeijão1);
		
		JButton btnFeijão2 = new JButton("-");
		
		btnFeijão2.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnFeijão2.setBounds(202, 53, 43, 40);
		contentPane.add(btnFeijão2);
		
		JButton btnMacarrão1 = new JButton("+");
		
			
		btnMacarrão1.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnMacarrão1.setBounds(280, 52, 43, 40);
		contentPane.add(btnMacarrão1);
		
		JButton btnMacarrão2 = new JButton("-");
		
		btnMacarrão2.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnMacarrão2.setBounds(339, 51, 43, 40);
		contentPane.add(btnMacarrão2);
	...
	//Instanciar objeto da classe Acao
		...
		//Feijão
		btnFeijão1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				a.feijao(true);
				Qtd.setText(String.valueOf(a.somar()));
				b.setFeijao(true);
		...
		btnFeijão2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b.setFeijao(false);
		...
		//Macarrao
		btnMacarrão1.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
		b.setMacarrao(true);
		a.feijao(true);
		Qtd.setText(String.valueOf(a.somar()));
		...
		btnMacarrão2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			a.feijao(false);
			Qtd.setText(String.valueOf(a.somar()));
			b.setMacarrao(false);

...
Object[] femi1 = {"Camisa Social Dudalina - R$170.00","Calça Jeans Miss Masi - R$99.90", "Bermuda Jeans - R$74.40"};
		...
		JOptionPane.showMessageDialog(null, "O valor total a pagar é de: R$ "+total);
		JOptionPane.showMessageDialog(null, "À vista esse valor é de: R$ "+vista+
											"\nA prazo fica: R$ "+total);
		
		Object[] paga = {"À vista","A prazo"};
	...
	case 0:
		do {
			pagamento1 = Double.parseDouble(JOptionPane.showInputDialog("O valor total a ser pago é de R$ "+vista+ "\n Quanto o cliente deseja pagar?"));
			}while (pagamento1 < vista);
		
		if (pagamento1 == total) {
			JOptionPane.showMessageDialog(null, "Transação concluída, troco não necessário");
		}else {
			JOptionPane.showMessageDialog(null, "O troco total a se pagar é de R$ "+(pagamento1 - total));
		}
	...
	case 1:
		...
		do {
			pagamento2 = Double.parseDouble(JOptionPane.showInputDialog("O valor total a ser pago é de R$ "+total+ "\n Quanto o cliente deseja pagar?"));
			}while (pagamento2 < total);
				
		if (pagamento2 == total) {
			JOptionPane.showMessageDialog(null, "Transação concluída, troco não necessário");
		}else {
			JOptionPane.showMessageDialog(null, "O troco total a se pagar é de R$ "+(pagamento2 - total));
		}
	...
	break;	
		...
		JOptionPane.showMessageDialog(null, "A quantidade de homens a se cadatrarem foram de: " +masc+ ". Corresponde à: "+per1+ "%"
											+"\nA quantidade de mulheres a se cadatrarem foram de: " +femi+ ". Corresponde à: "+per2+ "%");
		
		JOptionPane.showMessageDialog(null, "A quantidade de pessoas por faixa etária foram:" 
				+							"\nAté 17 anos: " +idade1+
											"\nDe 18 à 30 anos: " +idade2+
											"\nDe 31 à 50 anos: " +idade3+
